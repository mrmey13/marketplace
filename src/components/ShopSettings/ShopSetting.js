      ...
      <div className="page-content-wrapper">
        <div className="page">
          <div className="header">
            <div className="title">Thiết Lập Shop</div>
            <div className="desc">Thay đổi các cài đặt cho shop của bạn.</div>
          </div>
                ...
                <div className="">
                    ...
                    <div className="main">
                      ...
                      <div className="desc">
                        ...
                        <div className="subtitle">
                          Trong trường hợp hoạt động có rủi ro cao, hãy xác minh
                          hoạt động với OTP
                        </div>
                      </div>
                  ...
                  <div className="setting-card-row off">
                    <div className="main">
                      ...
                      <div className="desc">
                        <div className="title">Chế độ Tạm nghỉ</div>
                        <div className="subtitle">
                          Kích hoạt Chế độ Tạm nghỉ để ngăn khách hàng đặt đơn
                          hàng mới. Những đơn hàng đang tiến hành vẫn phải được
                          xử lý.
                        </div>
                      </div>
                      <div className="operations">
                        ...
                        >
                          ...
                          <i className="shop-icon">
                            <svg
                                ...
                                >
                                <path
                                    d="M288 864a32 32 0 0 0 53.6 23.6l384-352A32.11 32.11 0 0 0 736 512a32.39 32.39 0 0 0-10.3-23.6l-383-352a32 32 0 1 0-43.3 47.1L656.7 512 298.4 840.44A32 32 0 0 0 288 864z"
                                ></path>
                                </svg>
                          </i>
                        </button>
